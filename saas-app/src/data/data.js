...
export const MOCK = {
  ...
  clients: [
    { id: 'c1', first_name: 'Juan', last_name: 'PÃ©rez', phone: '11-2345-6789', email: 'juan@mail.com', dni: '30456789', is_frequent: true, vehicles: ['v1','v2'] },
    { id: 'c2', first_name: 'MarÃ­a', last_name: 'GonzÃ¡lez', phone: '11-3456-7890', email: 'maria@mail.com', dni: '28123456', is_frequent: true, vehicles: ['v3'] },
    { id: 'c3', first_name: 'Roberto', last_name: 'SÃ¡nchez', phone: '11-4567-8901', email: 'rober@mail.com', dni: '35678901', is_frequent: false, vehicles: ['v4'] },
    { id: 'c4', first_name: 'Ana', last_name: 'MartÃ­nez', phone: '11-5678-9012', email: 'ana@mail.com', dni: '32456123', is_frequent: false, vehicles: ['v5'] },
    { id: 'c5', first_name: 'Luis', last_name: 'FernÃ¡ndez', phone: '11-6789-0123', email: 'luis@mail.com', dni: '29876543', is_frequent: true, vehicles: ['v6','v7'] },
  ],
  ...
  inventory: [
    ...
    { id: 'i9', name: 'BujÃ­a NGK BKR6E', category: 'BujÃ­as', barcode: '4011558035655', brand: 'NGK', supplier: 'Importadora Norte', stock_type: 'UNIT', stock_quantity: 32, stock_min: 10, cost_price: 1800, sell_price: 3200 },
    ...
    { id: 'i11', name: 'Cubierta Pirelli P7 205/55 R16', category: 'Cubiertas', barcode: '8019227234893', brand: 'Pirelli', supplier: 'NeumÃ¡ticos Express', stock_type: 'UNIT', stock_quantity: 6, stock_min: 4, cost_price: 85000, sell_price: 125000 },
    { id: 'i12', name: 'LÃ­quido de Frenos DOT4', category: 'LÃ­quido Frenos', barcode: '7790074004001', brand: 'Bardahl', supplier: 'Distribuidora Sur', stock_type: 'VOLUME', stock_ml: 8500, stock_min_ml: 5000, container_size_ml: 1000, cost_price: 3500, sell_price: 2200, sell_price_per_ml: 2.2 },
  ],
  ...
  workOrders: [
    ...
    { id: 'wo2', order_number: 1046, client_id: 'c2', vehicle_id: 'v3', box_id: 'b2', mechanic: 'Pablo Ruiz', status: 'En Box', description: 'Cambio pastillas delanteras + revisiÃ³n frenos', km_at_entry: 32000, total_price: 35200, created_at: '2026-02-27T09:15:00', started_at: '2026-02-27T09:30:00' },
    ...
    { id: 'wo4', order_number: 1044, client_id: 'c5', vehicle_id: 'v6', box_id: 'b1', mechanic: 'Miguel Torres', status: 'Finalizado', description: 'Cambio cubiertas x4 + alineaciÃ³n', km_at_entry: 67000, total_price: 520000, created_at: '2026-02-26T14:00:00', completed_at: '2026-02-26T17:30:00' },
  ...
  appointments: [
    { id: 'a1', client: 'Juan PÃ©rez', vehicle: 'Toyota Corolla', title: 'Service 45.000km', date: '2026-02-27', time: '08:30', box: 'Box 1', status: 'En Curso', color: '#0df2f2' },
    { id: 'a2', client: 'MarÃ­a GonzÃ¡lez', vehicle: 'Chevrolet Cruze', title: 'Cambio pastillas', date: '2026-02-27', time: '09:15', box: 'Box 2', status: 'En Curso', color: '#0df2f2' },
    { id: 'a3', client: 'Roberto SÃ¡nchez', vehicle: 'VW Amarok', title: 'Service completo', date: '2026-02-27', time: '11:00', box: 'Box 3', status: 'Programado', color: '#39ff14' },
    { id: 'a4', client: 'Ana MartÃ­nez', vehicle: 'Fiat Cronos', title: 'Cambio cubiertas', date: '2026-02-28', time: '09:00', box: 'Box 4', status: 'Confirmado', color: '#0df2f2' },
    { id: 'a5', client: 'Luis FernÃ¡ndez', vehicle: 'Peugeot 208', title: 'RevisiÃ³n general', date: '2026-02-28', time: '14:00', box: 'Box 1', status: 'Programado', color: '#ff6b35' },
  ],
  ...
  promotions: [
    ...
    { id: 'pr2', name: 'Promo Cubiertas x4', description: 'LlevÃ¡ 4 cubiertas y la alineaciÃ³n es GRATIS', discount_type: 'FIXED', discount_value: 8500, is_active: true, category: 'Cubiertas' },
  ...
  checklist_template: [
    ...
    { key: 'nivel_frenos', label: 'LÃ­quido de frenos', group: 'Niveles' },
    { key: 'presion_neum', label: 'PresiÃ³n neumÃ¡ticos', group: 'NeumÃ¡ticos' },
    { key: 'estado_neum', label: 'Estado neumÃ¡ticos', group: 'NeumÃ¡ticos' },
    { key: 'freno_mano', label: 'Freno de mano', group: 'Frenos' },
    { key: 'limpia', label: 'Limpiaparabrisas', group: 'Otros' },
    { key: 'bateria', label: 'BaterÃ­a', group: 'Otros' },
    { key: 'correas', label: 'Correas', group: 'Otros' },
  ],

  suppliers: [
    { id: 's1', name: 'Distribuidora Sur', contact: 'Pedro LÃ³pez', phone: '11-1234-5678', cuit: '30-12345678-9' },
    { id: 's2', name: 'Importadora Norte', contact: 'Laura DÃ­az', phone: '11-2345-6789', cuit: '30-98765432-1' },
    { id: 's3', name: 'NeumÃ¡ticos Express', contact: 'MartÃ­n RÃ­os', phone: '11-3456-7890', cuit: '30-45678901-2' },
  ],
};
...
export const getClient = (id) => MOCK.clients.find(c => c.id === id);
export const getVehicle = (id) => MOCK.vehicles.find(v => v.id === id);
export const getClientVehicles = (clientId) => MOCK.vehicles.filter(v => v.client_id === clientId);
export const getLowStockItems = () => MOCK.inventory.filter(i =>
  (i.stock_type === 'UNIT' && i.stock_quantity <= i.stock_min) ||
  (i.stock_type === 'VOLUME' && i.stock_ml <= i.stock_min_ml)
);
export const getHealthColor = (score) => score >= 80 ? '#39ff14' : score >= 50 ? '#ffc107' : '#ff3366';
