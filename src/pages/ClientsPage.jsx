                                    ...
                                    <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                                        <div style={{ fontSize: 13, color: 'var(--text-secondary)', display: 'flex', alignItems: 'center', gap: 8 }}>
                                            ...
                                            {selectedClient?.phone && (
                                                <a href={getWhatsAppUrl(selectedClient.phone, `Hola ${selectedClient.first_name || ''}, nos comunicamos de VELOCCE SANTA FE...`)} target="_blank" rel="noopener noreferrer" className="btn btn-ghost btn-sm" style={{ padding: '4px 8px', color: '#25D366' }}>
